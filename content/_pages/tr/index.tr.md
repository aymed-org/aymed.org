            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="card m-2 h-100">
                    ...
                    <div class="card-footer text-center">
                        <a href="{{ site.baseurl }}/tr/haberler" class="card-link"><i class="fas fa-arrow mb-2"></i> Tüm Haberler</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                ...
                <!-- <img class="card-img-top" src="" alt=""> -->
                    ...
                    <div class="card-footer text-center">
                        <a href="{{ site.baseurl }}/tr/haberler" class="card-link"><i class="fas fa-arrow mb-2"></i> Tüm Duyurular</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                ...
                <!-- <img class="card-img-top" src="" alt=""> -->
                    ...
                    <div class="card-footer text-center">
                        <a href="{{ site.baseurl }}/tr/haberler" class="card-link"><i class="fas fa-arrow mb-2"></i> Tüm Etkinlikler</a>
                    </div>
                </div>
            </div>
        </div>
